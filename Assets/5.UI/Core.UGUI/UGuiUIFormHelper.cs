...
namespace UnityGameFramework.Runtime
{
    ...
    /// 默认界面辅助器。
    /// </summary>
    public class UGuiUIFormHelper : UIFormHelperBase
    {
        private IUIResourceLoader _resourceLoader = null;
        ...
        {
            _resourceLoader.UnloadAsset(uiFormAsset);
            Destroy((Object)uiFormInstance);
        }

        public void SetResourceLoader(IUIResourceLoader resourceLoader)
        {
